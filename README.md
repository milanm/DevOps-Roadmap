...
<p align="left">
 <a href="https://www.star-history.com/milanm/devops-roadmap">
  <picture>
   ...
   <source media="(prefers-color-scheme: light)" srcset="https://api.star-history.com/badge?repo=milanm/DevOps-Roadmap" />
   <img alt="Star History Rank" src="https://api.star-history.com/badge?repo=milanm/DevOps-Roadmap" />
  </picture>
 </a>
</p>
...
- [KubeStellar Console](https://console.kubestellar.io) - AI-powered open-source dashboard for multi-cluster Kubernetes management with natural-language agent queries, real-time observability, and workload deployment across edge and cloud environments. <sup>FREE</sup>
